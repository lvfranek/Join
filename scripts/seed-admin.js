    ...
    const { error: tasksError } = await supabase.from('tasks').insert([
      {
        ...
        assignees: [{ id: adminId, name: 'Demo Admin', initials: 'DA', color: '#1FD7C1' }],
        subtasks: ['Define login flow', 'Protect private routes'],
        assigned_to: adminId,
        created_by: adminId,
      },
      {
        ...
        due_date: '2026-06-01',
        category: 'User Story',
        assignees: [{ id: adminId, name: 'Demo Admin', initials: 'DA', color: '#FF7A00' }],
        subtasks: ['Implement drag and drop', 'Add task detail dialog'],
        assigned_to: adminId,
        created_by: adminId,
      },
      {
        ...
        due_date: '2026-07-15',
        category: 'Technical Task',
        assignees: [{ id: adminId, name: 'Demo Admin', initials: 'DA', color: '#462F8A' }],
        subtasks: ['Create reactive form', 'Add Supabase persistence'],
        assigned_to: adminId,
        created_by: adminId,
      },
    ]);
